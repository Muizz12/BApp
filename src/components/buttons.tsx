...
const styles = StyleSheet.create({
  PrimaryButtonsStyle: { justifyContent: "center", alignItems: "center", paddingVertical: 10, borderRadius: 5, backgroundColor: "#4C9AB4", },
  ...
  headingNavigationStyle: { display: "flex", justifyContent: "space-evenly", alignItems: "center", flexDirection: "row", marginTop: 20, },
  backIconStyle: { color: "black", fontSize: 20, fontWeight: "bold" },
  headingTextStyle: { color: "black", fontWeight: "bold", fontSize: 24, lineHeight: 28 },
})